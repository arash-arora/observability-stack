...
from observability_stack.evaluation.core import Evaluator, EvaluationResult, EvaluationSuite
...
def main():
    ...
    try:
        from observability_stack.evaluation import RagasFaithfulnessEvaluator
    ...
    try:
        from observability_stack.evaluation import DeepEvalAnswerRelevancyEvaluator
