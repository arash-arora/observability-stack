"""
app/core/evaluation/integrations/trace_optimization.py

Converts raw multi-agent execution traces into clean, token-efficient structures for LLM evaluation.
"""
import json
import ast
